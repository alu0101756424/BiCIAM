...
public class MultiobjectiveHillClimbingDistance extends Generator{
	...
	//Lista que contiene las distancias de cada solucion del frente de Pareto estimado
	...
	InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		//Agregando la primera solucion a la lista de soluciones no dominadas
...
//			distanceSolution.set(k, distanceSolution.get(k) + distance);
		...
		distance = 0.0;
		//Calculando la distancia del ultimo elemento (elemento insertado) respecto al resto de los elementos
